...
- Combat: continue moving dungeon failure insight state application and remaining post-battle story side-effect execution into TypeScript-compatible action bridges.
