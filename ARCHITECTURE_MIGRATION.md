...
- `src/core/farming/farming-runtime.ts` moves crop target lookup, solar-term crop affinity, yield bonus, projected harvest previews, planting and watering state planning, harvest yield planning, harvest quality scoring, crop growth visual specs, weather growth planning, and night crop growth/state planning into TypeScript.
...
- Farming: continue moving harvest accounting into TypeScript.
