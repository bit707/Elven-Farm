...
- `src/core/farming/farming-runtime.ts` moves crop target lookup, solar-term crop affinity, yield bonus, projected harvest previews, harvest quality scoring, and crop growth visual specs into TypeScript.
