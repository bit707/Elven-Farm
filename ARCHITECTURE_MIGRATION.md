...
- `src/core/npc/npc-runtime.ts` moves NPC schedule matching and schedule priority scoring into TypeScript.
...
- NPC: continue moving favor rewards, relationship memory, and dialogue gates into TypeScript.
