...
- `src/core/combat/dungeon-runtime.ts` moves dungeon boss skill ordering/turn selection, boss phase thresholds, boss skill pressure, spirit combat skill fallback/bonus, boss HP percentage/max-HP calculations, exploration encounter damage planning, and Boss exchange damage/shield/strike planning into TypeScript.
...
- Combat: continue moving dungeon enemy/boss state mutation, loot resolution, mechanic effects, and battle outcome application into TypeScript.
