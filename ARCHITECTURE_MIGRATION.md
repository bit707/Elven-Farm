...
- `src/core/quests/quest-runtime.ts` moves quest step progress, quest state checks, story quest start/done checks, quest reward claiming, configured event trigger readiness/ready-queue scanning/action classification/execute-group resolution/execution planning, configured-event side-quest accept/main-quest start/first-spirit birth/spirit UI unlock/cutscene/shop-open tutorial unlock/shop level-2 unlock/shop-tutorial completion/first pest risk spawn/Hu Sihai arrival/mine entrance unlock/Herb Valley unlock/Herb Valley finish/Spirit Manor start/Spirit Manor overview/Faction Order start/Fire Ruin unlock/Fire Ruin start/Fire Ruin finish/Chapter 4 drought start/Chapter 4 Lu truth start/Chapter 4 final nest unlock/Chapter 4 Pantao finale start/Chapter 4 final planting unlock/Chapter 4 final banquet/generic-unlock action planning, dialogue display, queue planning/state application, side-quest route/action readiness, side-quest action resolution planning, side-quest accept application planning, and side-quest clue visibility into TypeScript.
...
- Quests: continue moving remaining configured event execution side effects and remaining side-quest action side effects into TypeScript.
...
- Combat: continue moving remaining post-battle story side-effect execution into TypeScript-compatible action bridges.
