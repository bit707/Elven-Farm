...
- `src/core/npc/npc-runtime.ts` moves NPC schedule matching, schedule priority scoring, favor level calculation, claimable favor reward planning, and relationship memory readiness/progress planning into TypeScript.
...
- NPC: continue moving relationship memory write-side effects and dialogue gates into TypeScript.
