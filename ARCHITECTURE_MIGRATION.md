...
- `src/core/combat/dungeon-runtime.ts` moves dungeon boss skill ordering/turn selection, boss phase thresholds, boss skill pressure, spirit combat skill fallback/bonus, and boss HP percentage/max-HP calculations into TypeScript.
...
- Combat: continue moving dungeon enemy/boss state mutation, loot resolution, mechanic effects, and battle outcome planning into TypeScript.
