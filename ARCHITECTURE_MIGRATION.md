...
- `src/core/farming/farming-runtime.ts` moves crop target lookup, solar-term crop affinity, yield bonus, projected harvest previews, planting state planning, harvest yield planning, harvest quality scoring, crop growth visual specs, and night crop growth planning into TypeScript.
...
- Farming: continue moving watering state, crop growth, weather effects, and harvest accounting into TypeScript.
