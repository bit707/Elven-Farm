...
- `src/core/npc/npc-runtime.ts` moves NPC schedule matching, schedule priority scoring, favor level calculation, and claimable favor reward planning into TypeScript.
...
- NPC: continue moving relationship memory and dialogue gates into TypeScript.
